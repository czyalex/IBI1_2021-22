...
paternal_age=[30,35,40,45,50,55,60,65,70,75] # the original data
...
N=10
plt.title('the scatter plot for the health risk related to the father age when born')
plt.xlabel('father age')
plt.ylabel('the health risk')
x=paternal_age
y=age_risk
plt.scatter(x,y,N)
plt.show()
